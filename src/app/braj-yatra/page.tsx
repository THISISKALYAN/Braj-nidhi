    ...
    <div className="index-page braj-yatra-page">
      ...
      <footer className="site-footer">
        <div className="footer-top-links">
          ...
          <div className="footer-col"><h3>Stay & Book</h3><a href="/booking">Book Your Stay</a><a href="/weddings">Wedding Packages</a><a href="/corporate">Corporate Stays</a><Link href="/cancellation-policy">Refund Policy</Link></div>
